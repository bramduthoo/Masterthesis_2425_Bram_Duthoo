...
using DrWatson
@quickactivate "MasterThesis_BramDuthoo"
using Documenter
...
makedocs(;
    sitename = "MasterThesis_BramDuthoo",
...
if CI
    deploydocs(
        ...
        # https://PutYourGitHubNameHere.github.io/MasterThesis_BramDuthoo/dev/
        # (assuming you have enabled `gh-pages` deployment)
        repo = "github.com/PutYourGitHubNameHere/MasterThesis_BramDuthoo.git",
        target = "build",
        push_preview = true,
        devbranch = "main",
    )
